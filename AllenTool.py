...
class AllenTool:
    ...
    def get_num_sents_in_allen_file(self):
        ...
        num_sents = 1
        for line in lines:
            ex = AllenTool.read_allen_ex_line(line)
            if ex.sent_pair[0] != prev_in_sent:
                num_sents += 1
            prev_in_sent = ex.sent_pair[0]
        return num_sents
    ...
    def read_allen_file(self):
        ...
        for line in lines:
            ...
            # print("ooyp1", ex.sent_pair[0])
            # print("ooyp2", prev_in_sent)
            # print("ooyp3", ex.sent_pair[0] == prev_in_sent)
            if ex.sent_pair[0] != prev_in_sent:
                if prev_in_sent:
...
if __name__ == "__main__":
    def main1():
        ...
        for k, line in enumerate(lines[0:5]):
            ...
            ex = at.read_allen_ex_line(line)
            print(str(k+1) + ".")
            print(ex.sent_pair[0])
