...
def parse_allen_line(line):
    ...
    for str0 in ['arg1', 'rel', 'arg2']:
        ...
        parts.append(part)
    ext = Extraction(full_ztz, parts[0], parts[1], parts[2], confidence)

    return ext

def parse_allen_file(f_path):
    ...
    for line in lines:
        ...
        # print("ooyp1", ext.full_ztz)
        # print("ooyp2", prev_full_ztz)
        # print("ooyp3", ext.full_ztz == prev_full_ztz)
        if ext.full_ztz != prev_full_ztz:
            if prev_full_ztz:
                ztz_to_extractions[prev_full_ztz] = extractions[:-1]
                # print("llkml", prev_full_ztz, extractions)
                prev_full_ztz = ext.full_ztz
                extractions = [ext]
            else:
                prev_full_ztz = ext.full_ztz
...
if __name__ == "__main__":
    def main1():
        in_path = "data/oie4_extractions.tsv"
