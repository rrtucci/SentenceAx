...
with open("openie6-params_d0.txt", mode="r") as f0:
    lines = f0.readlines()
...
distinct_params = []
with open("openie6-params_d.txt", mode="w") as f:
    for line in lines:
...
with open("openie6-params_d.txt", mode="r") as f:
    for line in f:
...
with open("openie6-params_d.txt", mode="a") as f:
